...
//                    w820.append(start).append(num * 2.56).append(end).append("\r\n");
                    w240.append(start).append(num * 240 / defaultDp ).append(end).append("\r\n");
                    w480.append(start).append(num * 480 / defaultDp ).append(end).append("\r\n");
                    w600.append(start).append(num * 600 / defaultDp ).append(end).append("\r\n");
                    w720.append(start).append(num * 720 / defaultDp ).append(end).append("\r\n");
                    w800.append(start).append(num * 800 / defaultDp ).append(end).append("\r\n");
                    w820.append(start).append(num * 820 / defaultDp ).append(end).append("\r\n");
                } else {
